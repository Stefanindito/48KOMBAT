...
function throwEnemyWeapon() {
    ...
    enemy.body.appendChild(enemyWeapon); // Menambahkan senjata musuh ke dalam body atau kontainer yang sesuai
    ...
    // Menghapus senjata musuh setelah animasi selesai
    setTimeout(() => {
        enemyWeapon.remove();
...
function isCollisionPlayers(player, enemy) {
